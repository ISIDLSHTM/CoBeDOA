...
environments = ['Environment_7']
from environments import Environment_3_441_5

scrape_environments = [Environment_3_441_5]
target_percentage = 0.9
linestyle = ["-", "-",
             "-", "-", "-"]
colours = ['blue', 'green', 'black', 'red', 'purple']
...
for i, env in enumerate(environments):
    print(env)
    conn = sqlite3.connect('__Objective_3_Database.db')
    c = conn.cursor()
    ...
    for midx, _method in enumerate(['Very Strong, Correct',
                                    'Strong, Correct',
                                    'No Prior',
                                    'Strong, Incorrect',
